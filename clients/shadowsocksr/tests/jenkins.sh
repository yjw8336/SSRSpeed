...
run_test python tests/test.py --with-coverage -b "-m rc4-md5 -k testrc4 -s 192.168.2.191 -p 8388 -q" -a "-m rc4-md5 -k testrc4 -s 192.168.2.191 -p 8388 -l 1081 -vv"
run_test python tests/test.py --with-coverage -b "-m aes-256-cfb -k testrc4 -s 192.168.2.191 -p 8388 --workers 1" -a "-m aes-256-cfb -k testrc4 -s 192.168.2.191 -p 8388 -l 1081 -t 30 -qq -b 192.168.2.191"
run_test python tests/test.py --with-coverage --should-fail --url="http://192.168.2.191/" -b "-m aes-256-cfb -k testrc4 -s 192.168.2.191 -p 8388 --forbidden-ip=192.168.2.191,::1,8.8.8.8" -a "-m aes-256-cfb -k testrc4 -s 192.168.2.191 -p 8388 -l 1081 -t 30 -b 192.168.2.191"
...
run_test python tests/test.py --with-coverage --should-fail --tcp-only --url="http://192.168.2.191/" -b "-m aes-256-cfb -k testrc4 -s 192.168.2.191 -p 8388" -a "-m aes-256-cfb -k testrc4 -s 192.168.2.191 -p 8388 -l 1081 -t 30 -b 192.168.2.191"

# test localhost is available when forbidden list is empty
run_test python tests/test.py --with-coverage --tcp-only --url="http://192.168.2.191/" -b "-m aes-256-cfb -k testrc4 -s 192.168.2.191 -p 8388 --forbidden-ip=" -a "-m aes-256-cfb -k testrc4 -s 192.168.2.191 -p 8388 -l 1081 -t 30 -b 192.168.2.191"
